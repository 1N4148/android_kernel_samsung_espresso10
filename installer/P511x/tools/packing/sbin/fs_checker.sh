...
###### AGNi FS CHECKER v1.2 (P31xx)################

SYSTEM_PARTITION="FACTORYFS"
DATA_PARTITION="DATAFS"
CACHE_PARTITION="CACHE"
PRELOAD_PARTITION="HIDDEN"

SYSTEM="/dev/block/platform/omap/omap_hsmmc.1/by-name/$SYSTEM_PARTITION"
DATA="/dev/block/platform/omap/omap_hsmmc.1/by-name/$DATA_PARTITION"
CACHE="/dev/block/platform/omap/omap_hsmmc.1/by-name/$CACHE_PARTITION"
PRELOAD="/dev/block/platform/omap/omap_hsmmc.1/by-name/$PRELOAD_PARTITION"
